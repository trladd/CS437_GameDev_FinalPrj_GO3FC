...
function RunningMan(conn, playerNumber) {
    
        //Game Values - No change needed here
        this.conn = conn;
        this.playerNumber = playerNumber;
        this.gameName = "Running Man";
        this.keepGoing = true;
        ...
        conn.on('data', function (data) {
            console.log("Received to Running Man Datacontroller: " + data[0]);
            switch (data[0]) {
                //Various Cases for the first element of data being passed 
    
                case "gamejsGeneralData":
                    console.log("Received general data for Running Man:\n" + data[1]);
                    break;
            }
        });
        ...
        this.runGame = function () {
            $("#game_runningMan").slideDown(); //Displays your HTML pane
