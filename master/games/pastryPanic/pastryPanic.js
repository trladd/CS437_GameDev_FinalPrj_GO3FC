...
function PastryPanic(conn, playerNumber) {
        ...
        conn.on('data', function (data) {
            console.log("Received to PastryPanic.js Datacontroller: " + data[0]);
            switch (data[0]) {
                //Various Cases for the first element of data being passed 
    
                case "pastryPanicGeneralData":
                    console.log("Received general data for pastryPanic:\n" + data[1]);
                    break;
            }
        });
        ...
        this.runGame = function () {
            $("#game_pastryPanic").slideDown(); //Displays your HTML pane
