...
function MiniGolf(conn, playerNumber) {
        ...
        conn.on('data', function (data) {
            console.log("Received to MiniGolf.js Datacontroller: " + data[0]);
            switch (data[0]) {
                //Various Cases for the first element of data being passed 
    
                case "miniGolfGeneralData":
                    console.log("Received general data for miniGolf:\n" + data[1]);
                    break;
            }
        });
        ...
        this.runGame = function () {
            $("#game_miniGolf").slideDown(); //Displays your HTML pane
