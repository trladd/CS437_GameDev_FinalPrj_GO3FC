...
function VirtualDDR(conn, playerNumber) {
    
        //Game Values - No change needed here
        this.conn = conn;
        this.playerNumber = playerNumber;
        this.gameName = "Virtual DDR";
        this.keepGoing = true;
        ...
        conn.on('data', function (data) {
            console.log("Received to virtualDDR.js Datacontroller: " + data[0]);
            switch (data[0]) {
                //Various Cases for the first element of data being passed 
    
                case "gamejsGeneralData":
                    console.log("Received general data for virtualDDR.js:\n" + data[1]);
                    break;
            }
        });
        ...
        this.runGame = function () {
            $("#game_virtualDDR").slideDown(); //Displays your HTML pane
